            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
              <div className="order-2 md:order-1">
                <h1 className="text-4xl md:text-5xl font-bold mb-4">
                  Save Big on Near-Expiry Stock — Up to 95% OFF for Local Shopkeepers!
                </h1>
              ...
              <div className="order-1 md:order-2">
                <img
                  ...
                  src="/lovable-uploads/ef1f2ede-28f6-4a49-9d84-5a4937a35ab9.png"
                />
              </div>
            </div>
          </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 transition-transform hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-6">
                    Get near-expiry FMCG products from large chains at discounted rates. Perfect for retail shopkeepers
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 transition-transform hover:-translate-y-1 hover:shadow-lg">
                <div className="aspect-video overflow-hidden">
                  <img
                    alt="Xstore Fresh"
                    className="w-full h-full object-cover"
                    src="/lovable-uploads/678ffc9b-ba7c-4065-990e-bf864cbeaceb.jpg"
                  />
                </div>
                <div className="p-6">
                  <div className="flex items-center mb-4">
                  ...
                  <p className="text-gray-600 mb-6">
                    Daily delivery of fresh fruits, vegetables, and frozen goods sourced from local mandis. Ideal for
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Choose your city to see available products in your area. We're currently available in select major
                  cities.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Provide your shop details and delivery address. No payment needed - we'll deliver and collect on
                  delivery.
                </p>
              </div>
            </div>
