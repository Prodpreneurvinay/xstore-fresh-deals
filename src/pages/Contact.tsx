      ...
      <div className="container-custom py-12">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">support@xstore.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">123 Business Hub, Sector 5</p>
        ...
        <div className="mt-12">
          ...
          <div className="h-96 rounded-lg overflow-hidden shadow-md">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.3089235655876!2d77.2177855!3d28.6439805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x52c2b7494e204dce!2sNew%20Delhi%2C%20Delhi%2C%20India!5e0!3m2!1sen!2sus!4v1626423095562!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen={true}
              loading="lazy"
              title="Xstore Location Map"
            />
          </div>
        </div>
      </div>
