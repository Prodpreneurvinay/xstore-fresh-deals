...
const ProductCard = ({ product, onAddToCart }: ProductCardProps) => {
  ...
  // Determine unit type based on product category
  const getUnitType = (): 'pieces' | 'kg' => {
    const freshCategories = ['Vegetables', 'Fruits', 'Dairy', 'Meat', 'Frozen'];
    return freshCategories.includes(product.category) ? 'kg' : 'pieces';
  };
  ...
  return (
    <>
      ...
      <QuantitySelector
        ...
        onConfirm={handleQuantitySelected}
